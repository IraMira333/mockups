...
export const Hero = () => {
    ...
    return (
        <section className="pt-[120px] tab:pt-[160px] pc:pt-[128px] px-0 tab:pb-[76px] pc:pb-0 mx-auto">
            ...
            <h1 className="text-white-100 mx-auto text-center font-genos font-semibold text-4xl tab:text-6xl uppercase mb-8 tab:mb-[56px] pc:mb-[75px] tab:max-w-[827px] pc:max-w-[922px] px-4 tab:px-10 pc:px-0 pc:text-7xl">
                {t("title")}
            </h1>
