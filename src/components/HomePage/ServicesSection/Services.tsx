...
export const Services = () => {
    ...
    return (
        <Section id="services" className="pt-10 tab:pb-10 pc:pb-[60px]">
            <div className="text-white-100 font-semibold tab:text-2xl tab:text-left flex justify-between font-genos text-xl uppercase h-9 border-b border-b-white-100 mb-[28px] tab:mb-10 pc:mb-[60px]">
