    ...
    return (
        <Section id="toolkits" className="py-10">
            ...
            <div className="pc:flex pc:gap-5 pc:justify-center">
                <WaveAnimation className="border border-white-40 tab:gap-10 px-2  pc:mb-5 tab:w-[538px] tab:h-[300px] pc:w-[41%]">
                    <div className="relative z-10 tab:w-[51%]">
                        <h3 className=" font-genos font-semibold text-3xl uppercase mb-4 tab:text-5xl">
                            {t("beetleTitle")}
                        </h3>
                        <p>{t("beetleText")}</p>
                    </div>
                    <div className="tab:w-[48.5%] h-auto relative z-10">
                        <Image
                            src="/beetle.png"
                            alt="beetle"
                            width={263}
                ...
                <WaveAnimation className="border border-white-40  px-2 tab:gap-10 pc:mb-5 tab:w-[688px] tab:h-[327px] pc:h-[300px] pc:w-[57%]">
            ...
            <div className="pc:flex pc:gap-5 pc:justify-center">
                <WaveAnimation className="border border-white-40 px-0 pc:mb-0 tab:w-[650px] tab:h-[300px] tab:flex-row-reverse tab:gap-10 pc:w-[49%]">
                    <div className="px-2 relative z-10 tab:w-[51%]">
                        <h3 className="font-genos font-semibold text-3xl uppercase mb-4 tab:text-5xl">
                            {t("yellowScanTitle")}
                        </h3>
                ...
                <WaveAnimation className="border border-white-40  px-2  mb-0 tab:w-[647px] tab:h-[300px] tab:flex-row-reverse tab:gap-10 pc:w-[49%]">
                    ...
                    <div className="w-[203px] h-auto mx-auto tab:w-[48.5%] relative z-10">
                        <Image
                            src="/sony.png"
                            alt="Sony"
                            width={315}
